...
(assert (let ((a!1 (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff)))
  ...
  (or (= (str.len |3 Fill 2|) 0) (not (str.in_re |3 Fill 2| a!1)) a!2)))
(assert (let ((a!1 (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff)))
                  (re.union (re.range (seq.unit #x00) (seq.unit #x09))
                            (re.range (seq.unit #x0b) (seq.unit #xff)))
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
...
(let ((a!3 (str.substr |3 Fill 2|
      ...
      (a!8 (str.in_re (str.substr |3 Fill 2|
                                  0
                                  (+ (str.len |3 Fill 2|) (* (- 1) a!2)))
                      a!7)))
...
(let ((a!4 (str.substr |3 Fill 2|
      ...
      (a!6 (str.in_re (str.substr |3 Fill 2| 0 (+ (str.len |3 Fill 2|) a!3))
                      a!5))
      (a!8 (ite (>= a!2 0)
                ""
...
(let ((a!4 (ite (>= a!2 0)
                ""
                (str.substr |3 Fill 2| 0 (+ (str.len |3 Fill 2|) a!3))))
      (a!8 (str.in_re (str.substr |3 Fill 2| a!1 (+ (str.len |3 Fill 2|) a!3))
                      a!7))
      (a!9 (str.in_re (str.substr |3 Fill 2| 0 (+ (str.len |3 Fill 2|) a!3))
                      a!7)))
(let ((a!5 (ite (>= a!1 0)
...
(let ((a!5 (str.in_re (str.substr |3 Fill 2|
                                  a!3
...
(let ((a!4 (not (<= (+ (str.len |3 Fill 2|) (* (- 1) a!3)) 0)))
      (a!6 (str.in_re (str.substr |3 Fill 2|
                                  a!3
                                  (+ (str.len |3 Fill 2|) (* (- 1) a!3)))
                      a!5)))
  (not (and a!4 a!6))))))
