...
(let ((a!3 (ite (>= (+ (str.len |4 Fill 1|) (str.len |4 Fill 0|)) 0)
                (+ (str.len |4 Fill 1|) (str.len |4 Fill 0|))
                a!2)))
(let ((a!5 (str.in_re (str.substr |1 Fill 2|
                                  (+ (str.len |4 Fill 1|) (str.len |4 Fill 0|))
...
(let ((a!4 (str.substr |1 Fill 2|
      ...
      (a!6 (str.in_re (str.substr |1 Fill 2| 0 (+ (str.len |1 Fill 2|) a!3))
                      a!5))
      (a!8 (ite (>= a!2 0)
                ""
...
(let ((a!2 (ite (>= (+ (str.len |4 Fill 1|)
                ...
                (+ (str.len |4 Fill 1|)
                   ...
                   (str.len |5 Fill 0|))
                (ite (>= a!1 0) a!1 0))))
  (str.in_re (str.substr |1 Fill 2| a!2 (+ (str.len |1 Fill 2|) (* (- 1) a!2)))
             a!3))))
