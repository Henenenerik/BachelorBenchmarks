...
(let ((a!2 (re.++ (str.to_re (str.++ (seq.unit #x2d) (seq.unit #x2d)))
                  ...
                  (str.to_re (seq.unit #x3d))
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
  (= (str.in_re (select Constructed_Argument 0) a!2) IsMatch_/^--.+=/_0))))
...
(let ((a!2 (re.++ (str.to_re (str.++ (seq.unit #x2d)
                  ...
                  (re.* a!1)
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
  (= (str.in_re (select Constructed_Argument 0) a!2) IsMatch_/^--no-.+/_1))))
...
(let ((a!2 (re.++ (str.to_re (str.++ (seq.unit #x2d) (seq.unit #x2d)))
                  ...
                  (re.* a!1)
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
  (= (str.in_re (select Constructed_Argument 0) a!2) IsMatch_/^--.+/_2))))
...
(let ((a!2 (re.++ (str.to_re (seq.unit #x2d))
                  ...
                  (re.* a!1)
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
  (= (str.in_re (select Constructed_Argument 0) a!2) |IsMatch_/^-[^-]+/_3|))))
...
(let ((a!5 (re.++ (re.union (str.to_re (seq.unit #x2d))
                  ...
                  a!3
                  (re.union (str.to_re "") a!4))))
  (or (not (str.in_re (select Constructed_Argument 0) a!5))
...
(let ((a!5 (re.++ (re.union (str.to_re (seq.unit #x2d))
                  ...
                  a!3
                  (re.union (str.to_re "") a!4))))
  (= (str.in_re (select Constructed_Argument 0) a!5)
