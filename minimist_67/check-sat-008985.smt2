...
(assert (let ((a!1 (re.union (re.range (seq.unit #x30) (seq.unit #x39))
  ...
  (str.in_re |5 Fill 1| (re.++ a!1 (re.* a!1)))))
...
(let ((a!2 (re.++ (str.to_re (str.++ (seq.unit #x30) (seq.unit #x78)))
                  a!1
                  (re.* a!1))))
  (or (not (str.in_re (select Constructed_Argument 1) a!2))
...
(let ((a!2 (re.++ (str.to_re (str.++ (seq.unit #x30) (seq.unit #x78)))
                  a!1
                  (re.* a!1))))
  (= (str.in_re (select Constructed_Argument 1) a!2)
     |IsMatch_/^0x[0-9a-f]+$/i_5|))))
(assert (not |IsMatch_/^0x[0-9a-f]+$/i_5|))
(assert (str.in_re |6 Fill 0|
...
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
  ...
  (str.in_re |6 Fill 1| a!1)))
(assert (= |6 Fill 2| (seq.unit #x2e)))
(assert (str.in_re |6 Fill 3| (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
(assert (= |6 Fill 4| (seq.unit #x2e)))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |6 Fill 5| a!1)))
...
(let ((a!5 (re.++ (re.union (str.to_re (seq.unit #x2d))
  ...
  (str.in_re (str.++ |6 Fill 6| |6 Fill 11| |6 Fill 10|) a!5)))))
...
(let ((a!5 (re.++ (re.union (str.to_re (seq.unit #x2d))
                  ...
                  a!3
                  (re.union (str.to_re "") a!4))))
  (or (not (str.in_re (select Constructed_Argument 1) a!5))
...
(let ((a!5 (re.++ (re.union (str.to_re (seq.unit #x2d))
                  ...
                  a!3
                  (re.union (str.to_re "") a!4))))
  (= (str.in_re (select Constructed_Argument 1) a!5)
     |IsMatch_/^[-+]?(?:\\d+(?:\\.\\d*)?\|\\.\\d+)(e[-+]?\\d+)?$/_6|)))))
(assert (not |IsMatch_/^[-+]?(?:\\d+(?:\\.\\d*)?\|\\.\\d+)(e[-+]?\\d+)?$/_6|))
(assert (str.in_re |7 Fill 0|
...
(assert (let ((a!1 (= (ite (= (str.len |3 Fill 2|) 0) "" |3 Fill 2|)
      ...
      (a!2 (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff)))
                  (re.union (re.range (seq.unit #x00) (seq.unit #x09))
                            (re.range (seq.unit #x0b) (seq.unit #xff)))
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
  (or (= (str.len |3 Fill 2|) 0) a!1 (not (str.in_re |3 Fill 2| a!2)))))
(assert (let ((a!1 (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff)))
                  (re.union (re.range (seq.unit #x00) (seq.unit #x09))
                            (re.range (seq.unit #x0b) (seq.unit #xff)))
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
(let ((a!2 (not (or (= (str.len |3 Fill 2|) 0) (not (str.in_re |3 Fill 2| a!1))))))
  (= a!2 IsMatch_/./_7))))
...
(assert (let ((a!1 (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff)))
                  (re.union (re.range (seq.unit #x00) (seq.unit #x09))
                            (re.range (seq.unit #x0b) (seq.unit #xff)))
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
  (str.in_re |3 Fill 2| a!1)))
(assert (str.in_re |8 Fill 0|
           (re.union (re.range (seq.unit #x00) (seq.unit #x09))
                     (re.range (seq.unit #x0b) (seq.unit #xff)))))
...
(let ((a!3 (str.substr |3 Fill 2|
      ...
      (a!5 (str.in_re (str.substr |3 Fill 2|
                                  0
                                  (+ (str.len |3 Fill 2|) (* (- 1) a!2)))
                      a!4))
...
(let ((a!2 (ite (>= (+ (str.len |7 Fill 1|) (str.len |7 Fill 0|)) 0)
                (+ (str.len |7 Fill 1|) (str.len |7 Fill 0|))
                a!1)))
(let ((a!4 (str.in_re (str.substr |3 Fill 2|
                                  a!2
                                  (+ (str.len |3 Fill 2|) (* (- 1) a!2)))
                      a!3)))
...
(let ((a!2 (ite (>= (+ (str.len |7 Fill 1|) (str.len |7 Fill 0|)) 0)
                (+ (str.len |7 Fill 1|) (str.len |7 Fill 0|))
                a!1)))
  (str.in_re (str.substr |3 Fill 2| a!2 (+ (str.len |3 Fill 2|) (* (- 1) a!2)))
             a!3))))
(assert (not (= (select Constructed_Argument 0)
        (str.++ (seq.unit #x2d)
                (seq.unit #x2d)
