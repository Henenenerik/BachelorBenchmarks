...
(assert (str.in_re |0 Fill 0| (re.union (str.to_re "") (str.to_re (seq.unit #x76)))))
...
(assert (let ((a!1 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
  ...
  (str.in_re |0 Fill 4| (re.union (str.to_re (seq.unit #x30)) a!1))))
...
(assert (let ((a!1 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |0 Fill 9| (re.union (str.to_re (seq.unit #x30)) a!1))))
...
(assert (let ((a!1 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |0 Fill 14| (re.union (str.to_re (seq.unit #x30)) a!1))))
...
(let ((a!5 (re.++ (str.to_re (seq.unit #x2e))
                  (re.union (str.to_re (seq.unit #x30)) a!1 a!4))))
(let ((a!6 (re.++ (re.union (str.to_re (seq.unit #x30)) a!1 a!4) (re.* a!5))))
  (str.in_re (str.++ |0 Fill 23| |0 Fill 32|) a!6)))))))
...
(let ((a!5 (re.++ (str.to_re (seq.unit #x2e))
                  (re.union (str.to_re (seq.unit #x30)) a!1 a!4)))
      (a!8 (re.* (re.++ (str.to_re (seq.unit #x2e)) a!7))))
(let ((a!6 (re.++ (str.to_re (seq.unit #x2d))
                  (re.union (str.to_re (seq.unit #x30)) a!1 a!4)
                  (re.* a!5)))
      (a!9 (re.union (str.to_re "") (re.++ (str.to_re (seq.unit #x2b)) a!7 a!8))))
(let ((a!10 (re.++ (re.union (str.to_re "") (str.to_re (seq.unit #x76)))
                   (re.union (str.to_re (seq.unit #x30)) a!1)
...
(let ((a!7 (re.++ (str.to_re (seq.unit #x2e))
                  (re.union (str.to_re (seq.unit #x30)) a!3 a!6)))
      (a!10 (re.* (re.++ (str.to_re (seq.unit #x2e)) a!9))))
(let ((a!8 (re.++ (str.to_re (seq.unit #x2d))
                  (re.union (str.to_re (seq.unit #x30)) a!3 a!6)
                  (re.* a!7)))
      (a!11 (re.union (str.to_re "")
                      (re.++ (str.to_re (seq.unit #x2b)) a!9 a!10))))
(let ((a!12 (re.++ (re.union (str.to_re "") (str.to_re (seq.unit #x76)))
                   (re.union (str.to_re (seq.unit #x30)) a!3)
                   (str.to_re (seq.unit #x2e))
                   (re.union (str.to_re (seq.unit #x30)) a!3)
                   (str.to_re (seq.unit #x2e))
                   (re.union (str.to_re (seq.unit #x30)) a!3)
