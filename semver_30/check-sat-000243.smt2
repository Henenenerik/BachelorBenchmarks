...
(assert (let ((a!1 (re.* (re.union (str.to_re (seq.unit #x76))
                           (str.to_re (seq.unit #x3d))
                           (str.to_re (seq.unit #x73))))))
  (str.in_re |0 Fill 0| a!1)))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |0 Fill 1| a!1)))
(assert (= |0 Fill 2| (seq.unit #x2e)))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |0 Fill 3| a!1)))
(assert (= |0 Fill 4| (seq.unit #x2e)))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |0 Fill 5| a!1)))
(assert (str.in_re |0 Fill 6| (re.union (str.to_re (seq.unit #x2d)) (str.to_re ""))))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |0 Fill 7| a!1)))
(assert (str.in_re |0 Fill 8| (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
(assert (str.in_re |0 Fill 9|
...
(assert (let ((a!1 (re.* (re.union (re.range (seq.unit #x30) (seq.unit #x39))
                           ...
                           (re.range (seq.unit #x61) (seq.unit #x7a))
                           (re.range (seq.unit #x41) (seq.unit #x5a))))))
  (str.in_re |0 Fill 10| a!1)))
(assert (or (= |0 Fill 11| |0 Fill 7|)
    (= |0 Fill 11| (str.++ |0 Fill 8| |0 Fill 9| |0 Fill 10|))))
(assert (= |0 Fill 12| (seq.unit #x2e)))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in_re |0 Fill 13| a!1)))
(assert (str.in_re |0 Fill 14| (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
(assert (str.in_re |0 Fill 15|
           (re.union (str.to_re (seq.unit #x2d))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x41) (seq.unit #x5a)))))
(assert (let ((a!1 (re.* (re.union (re.range (seq.unit #x30) (seq.unit #x39))
...
(let ((a!5 (re.* (re.++ (str.to_re (seq.unit #x2e)) (re.union a!1 a!4)))))
  (str.in_re (str.++ |0 Fill 11| |0 Fill 17|) (re.++ (re.union a!1 a!4) a!5)))))))
(assert (= |0 Fill 18| (seq.unit #x2b)))
(assert (let ((a!1 (re.union (re.range (seq.unit #x30) (seq.unit #x39))
                     (str.to_re (seq.unit #x2d))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x41) (seq.unit #x5a)))))
  (str.in_re |0 Fill 19| (re.++ a!1 (re.* a!1)))))
(assert (= |0 Fill 20| (seq.unit #x2e)))
(assert (let ((a!1 (re.union (re.range (seq.unit #x30) (seq.unit #x39))
                     (str.to_re (seq.unit #x2d))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x41) (seq.unit #x5a)))))
  (str.in_re |0 Fill 21| (re.++ a!1 (re.* a!1)))))
(assert (let ((a!1 (re.union (re.range (seq.unit #x30) (seq.unit #x39))
                     (str.to_re (seq.unit #x2d))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x41) (seq.unit #x5a)))))
(let ((a!2 (re.* (re.++ (str.to_re (seq.unit #x2e)) (re.++ a!1 (re.* a!1))))))
  (str.in_re (str.++ |0 Fill 19| (seq.unit #x2e) |0 Fill 21|)
...
(assert (let ((a!1 (re.* (re.union (str.to_re (seq.unit #x76))
      ...
      (a!2 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
      (a!3 (re.union (str.to_re (seq.unit #x2d))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x41) (seq.unit #x5a)))))
...
(let ((a!6 (re.* (re.++ (str.to_re (seq.unit #x2e)) (re.union a!2 a!5))))
      (a!9 (re.* (re.++ (str.to_re (seq.unit #x2e)) a!8))))
(let ((a!7 (re.++ (re.union (str.to_re (seq.unit #x2d)) (str.to_re ""))
                  (re.union a!2 a!5)
                  a!6))
      (a!10 (re.union (str.to_re "")
                      (re.++ (str.to_re (seq.unit #x2b)) a!8 a!9))))
...
(assert (let ((a!1 (str.substr Constructed_Argument
      ...
      (a!3 (re.* (re.union (str.to_re (seq.unit #x76))
                           (str.to_re (seq.unit #x3d))
                           (str.to_re (seq.unit #x73)))))
      (a!4 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
      (a!5 (re.union (str.to_re (seq.unit #x2d))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x41) (seq.unit #x5a)))))
...
(let ((a!7 (re.++ (re.* (re.range (seq.unit #x30) (seq.unit #x39))) a!5 a!6))
      (a!10 (re.++ (re.union (re.range (seq.unit #x30) (seq.unit #x39)) a!5)
                   a!6)))
(let ((a!8 (re.* (re.++ (str.to_re (seq.unit #x2e)) (re.union a!4 a!7))))
      (a!11 (re.* (re.++ (str.to_re (seq.unit #x2e)) a!10))))
(let ((a!9 (re.++ (re.union (str.to_re (seq.unit #x2d)) (str.to_re ""))
                  (re.union a!4 a!7)
                  a!8))
      (a!12 (re.union (str.to_re "")
                      (re.++ (str.to_re (seq.unit #x2b)) a!10 a!11))))
(let ((a!13 (str.in_re a!2
                       (re.++ a!3
                              a!4
                              (str.to_re (seq.unit #x2e))
                              a!4
